...
function foundation_scripts_basic()
{
	...
	wp_register_script( 'prefixfree', get_template_directory_uri() . '/js/prefixfree.js' );
	wp_enqueue_script( 'prefixfree' );
	wp_register_script( 'reveal', get_template_directory_uri() . '/js/jquery.reveal.js', array( 'jquery' ), true );
	wp_enqueue_script( 'reveal' );
	wp_register_script( 'orbit', get_template_directory_uri() . '/js/jquery.orbit-1.4.0.js', array( 'jquery' ), true  );
	wp_enqueue_script( 'orbit' );
	wp_register_script( 'tooltips', get_template_directory_uri() . '/js/jquery.tooltips.js', array( 'jquery' ), true  );
	wp_enqueue_script( 'tooltips' );
	wp_register_script( 'placeholder', get_template_directory_uri() . '/js/jquery.placeholder.min.js', array( 'jquery' ), true  );
	wp_enqueue_script( 'placeholder' );
	wp_register_script( 'forms', get_template_directory_uri() . '/js/jquery.customforms.js', array( 'jquery' ), true  );
	wp_enqueue_script( 'forms' );
	wp_register_script( 'app', get_template_directory_uri() . '/js/app.js', array( 'jquery' ), true  );
	wp_enqueue_script( 'app' );
}
add_action( 'wp_enqueue_scripts', 'foundation_scripts_basic', 5 );
